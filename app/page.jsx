  ...
  return (
    <div className={styles.container}>
      <div className={styles.storyContent}>
        ...
        Celestial Biscuit is a curious space, filled with rules that don&apos;t make sense until they do.  
        A little strange, a little clever, and entirely its own thing.  
        </p>
        <p className={styles.paragraph}>
        Ready to take on a challenge unlike any other?
        </p>
        <StorylineClient />
      </div>
    </div>
